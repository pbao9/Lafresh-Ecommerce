                ...
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('Danh sách khách hàng') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header justify-content-between">
                    ...
                    <x-link :href="route('admin.user.create')" class="btn btn-primary"><i
                            class="ti ti-plus"></i>{{ __('Thêm khách hàng') }}</x-link>
                </div>
                <div class="card-body">
