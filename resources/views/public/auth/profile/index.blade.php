                ...
                <div class="row col-md-9 col-12">
                    <div class="col-lg-6 col-12">
                        <div class="mb-3">
                            ...
                            <x-input type="text" class="shadow-none" name="fullname" :value="$auth->fullname" :placeholder="trans('Nhập họ và tên')"
                                :required="true" />
                        </div>
                    </div>  <div class="col-lg-6 col-12">
                        <div class="mb-3">
                            <label class="form-label required">@lang('name_store')</label>
                            <x-input type="text" class="shadow-none" name="name_store" :value="$auth->name_store" :placeholder="trans('Tên cửa hàng')"
                                :required="true" />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="mb-3">
                            <label class="form-label required">@lang('Chiết khấu cá nhân')</label>
                            <x-input type="text" class="shadow-none form-control" :value="$auth->discount_user . '%'" disabled="true" />
                        </div>
                    </div>
