                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="mb-3">
                                ...
                                <x-input name="fullname" :required="true" :placeholder="trans('Họ và tên')"
                                         :value="old('fullname')"/>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="mb-3">
                                ...
                                <x-input name="phone" :required="true" :placeholder="trans('Số điện thoại')"
                                         :value="old('phone')"/>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="mb-3">
                                <label class="form-label">@lang('Tên cửa hàng')</label>
                                <x-input name="name_store" :required="true" :placeholder="trans('Tên cửa hàng')"
                        ...
                        <div class="col-md-6 col-12">
                            <div class="mb-3">
                                ...
                                <x-input name="address" :required="true" :placeholder="trans('Địa chỉ')"
                                         :value="old('address')"/>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <x-input-email name="email" :required="true" :placeholder="trans('Email')"
                                               :value="old('email')"/>
                            </div>
                        </div>
