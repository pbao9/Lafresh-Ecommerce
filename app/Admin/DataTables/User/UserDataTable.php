...
class UserDataTable extends BaseDataTable
{
    ...
    protected function editColumnDiscountUser()
    {
        $this->instanceDataTable = $this->instanceDataTable->editColumn('discount_user', function ($discountUser) {
            return $discountUser->discount_user . '%';
    ...
    {
        $this->instanceDataTable = $this->instanceDataTable->rawColumns(['fullname', 'discount_user', 'action']);
    }
